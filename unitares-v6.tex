...
and established by contraction analysis (Appendix~B).
...
$M = \operatorname{diag}(0.1, 0.2, 1.0, 0.08)$. The spectral
abscissa of the linearized system at the equilibrium gives
$\alpha_c \approx 0.13$ at production parameters; a conservative
Gershgorin argument establishes a strictly-less lower bound of
$\alpha_c = 0.019$ used for the stochastic and network bounds in
\Cref{sec:stochastic,sec:network}. Both certificates appear in
