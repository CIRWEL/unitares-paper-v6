...
ProbGuard~\cite{probguard2025} takes a probabilistic
...
are not themselves thermodynamic quantities---the analogy was a
labeling convenience, not a derivation. The phenomenological form
leaves every constant hand-tuned and every threshold empirically
discovered rather than derived. This section upgrades the
phenomenology to a computable information-theoretic grounding
without changing the dynamics of \Cref{sec:equations}.
...
formulations. We kept the $\{E, I, S, V, C\}$ symbols and the
dynamics; we replaced what they mean and how they are normalized.
...
\bibitem[ProbGuard(2025)]{probguard2025}
ProbGuard.
\newblock Probabilistic runtime monitoring of {LLM} agents via {DTMC}
  model checking.
