...
self-consistency sampling---draw $k$ responses at temperature
$T > 0$, group by semantic equivalence, and compute the entropy of
the equivalence-class distribution as an estimator of $H(q)$.
