...
[![Latest: paper-v6.9](https://img.shields.io/badge/latest-paper--v6.9-brightgreen.svg)](https://github.com/CIRWEL/unitares-paper-v6/releases/latest)

- 📄 [`unitares-v6.pdf`](./unitares-v6.pdf) — the paper (30 pages, latest tag [`paper-v6.9`](https://github.com/CIRWEL/unitares-paper-v6/releases/tag/paper-v6.9))
...
The concept DOI above resolves to the latest version; each tagged release (`paper-v6.0` through `paper-v6.9`) has its own version DOI.
